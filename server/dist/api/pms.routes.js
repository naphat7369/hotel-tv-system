...
router.post('/checkin', async (req, res) => {
    ...
    if (!targetIp && targetDeviceId) {
        const deviceStatus = socket_1.connectedDevices.get(targetDeviceId);
...
router.post('/checkout', async (req, res) => {
    ...
    try {
        ...
        await (0, adb_service_1.clearGuestApps)(targetIp);
...
router.get('/status/:ip', async (req, res) => {
    ...
    for (const device of socket_1.connectedDevices.values()) {
